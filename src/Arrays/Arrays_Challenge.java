...
public class Arrays_Challenge {
	...
	public static void main(String[] args) {
		// #1 Write a Java program to find the index of an array element. Print "not found" if the element does not exist in the array.
...
//#2 Write a Java program to copy an array by iterating the array. Use a for or while loop to do this.

//Hint: This challenge is similar to printing the elements of an array
